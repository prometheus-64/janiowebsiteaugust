...
const useCases = [
  {
    title: "How Disney Cut Logistics Costs by 35% While Expanding Across Asia",
    ...
    href: "/use-cases/disney-case-study",
    metrics: [
  ...
  {
    title: "GOAT's 2-Week Expansion into Southeast Asia",
    category: "Scaling",
    industry: "Fashion",
  ...
  {
    title: "Swarovski's Premium Service Standards Across Borders",
    ...
    href: "/use-cases/swarovski-luxury",
    metrics: [
  ...
  {
    title: "Beyond The Vines: From Startup to Regional Leader",
    category: "Ecommerce",
    ...
    href: "/use-cases/beyond-the-vines",
    metrics: [
  ...
  {
    title: "Shopee's Unified Cross-Border Operations",
    ...
    href: "/use-cases/shopee-unification",
    metrics: [
  ...
  {
    title: "Lazada's Peak Season Success Story",
    category: "Scaling",
    industry: "E-commerce Platform",
    ...
    href: "/use-cases/lazada-peak-season",
    metrics: [
