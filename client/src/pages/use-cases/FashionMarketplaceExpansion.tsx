...
const FashionMarketplaceExpansion = () => {
  const useCase = getUseCaseBySlug('fashion-marketplace-expansion');

  if (!useCase) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <PageSEO page="useCaseFashionMarketplaceExpansion" />
...
export default FashionMarketplaceExpansion;
