...
const MarketplaceUnification = () => {
  const useCase = getUseCaseBySlug('marketplace-unification');

  if (!useCase) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <PageSEO page="useCaseMarketplaceUnification" />
...
export default MarketplaceUnification;
