...
const EntertainmentLeaderCostReduction = () => {
  const useCase = getUseCaseBySlug('entertainment-leader-cost-reduction');

  if (!useCase) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <PageSEO page="useCaseEntertainmentLeaderCostReduction" />
...
export default EntertainmentLeaderCostReduction;
